...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(68.15,16.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.wall, new cjs.Rectangle(31.7,-131.2,73,295), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(8).call(this.frame_8).wait(1).call(this.frame_9).wait(31));
	...
	this.instance_1.setTransform(-58,-32);

	this.instance_2 = new lib.c04();
	this.instance_2.setTransform(-58,-32);

	this.instance_3 = new lib.c05();
	this.instance_3.setTransform(-58,-32);

	this.instance_4 = new lib.c06();
	this.instance_4.setTransform(-58,-32);

	this.instance_5 = new lib.c07();
	this.instance_5.setTransform(-58,-32);

	this.instance_6 = new lib.c08();
	this.instance_6.setTransform(-58,-32);

	this.instance_7 = new lib.c09();
	this.instance_7.setTransform(-58,-32);

	this.instance_8 = new lib.c10();
	this.instance_8.setTransform(-58,-32);

	this.instance_9 = new lib.c11();
	this.instance_9.setTransform(-58,-32);

	this.instance_10 = new lib.c12();
	this.instance_10.setTransform(-58,-32);

	this.instance_11 = new lib.c13();
	this.instance_11.setTransform(-58,-32);

	this.instance_12 = new lib.c14();
	this.instance_12.setTransform(-58,-32);

	this.instance_13 = new lib.c15();
	this.instance_13.setTransform(-58,-32);

	this.instance_14 = new lib.c16();
	this.instance_14.setTransform(-58,-32);

	this.instance_15 = new lib.c17();
	this.instance_15.setTransform(-58,-32);

	this.instance_16 = new lib.c18();
	this.instance_16.setTransform(-58,-32);

	this.instance_17 = new lib.c19();
	this.instance_17.setTransform(-58,-32);

	this.instance_18 = new lib.c20();
	this.instance_18.setTransform(-58,-32);

	this.instance_19 = new lib.c21();
	this.instance_19.setTransform(-58,-32);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},9).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_16}]},1).to({state:[{t:this.instance_17}]},1).to({state:[{t:this.instance_18}]},1).to({state:[{t:this.instance_19}]},1).to({state:[]},1).to({state:[]},1).wait(10));

	// btn
	this.instance_20 = new lib.bird01();
	this.instance_20.setTransform(-56,-22);

	this.instance_21 = new lib.bird02();
	this.instance_21.setTransform(-56,-22);

	this.instance_22 = new lib.bird03();
	this.instance_22.setTransform(-56,-22);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_20}]}).to({state:[{t:this.instance_21}]},3).to({state:[{t:this.instance_22}]},3).to({state:[]},3).wait(31));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-58,-32,59,59);
...
if (reversed == null) { reversed = false; }
	...
	// 圖層_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFF00").ss(1,1,1).p("AFFAAQAACGhgBfQhfBgiGAAQiGAAhfhgQhfhfAAiGQAAiGBfhfQBfhfCGAAQCGAABfBfQBgBfAACGg");
	this.shape.setTransform(32.45,32.45);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000033").s().p("AjkDmQhfhfgBiHQABiFBfhfQBfhfCFgBQCHABBfBfQBfBfgBCFQABCHhfBfQhfBfiHgBQiFABhfhfg");
	this.shape_1.setTransform(32.45,32.45);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ball, new cjs.Rectangle(-1,-1,66.9,66.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.ball.name = "ball";
	this.ball.setTransform(333.7,207.55,1,1.0015,0,0,0,32.5,32.5);

	this.birdlife = new lib.bridlife();
	this.birdlife.name = "birdlife";
	this.birdlife.setTransform(119,151,1,1,0,0,0,-1,-8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.birdlife},{t:this.ball}]}).wait(40));

	// Objects
	this.wall = new lib.wall();
	this.wall.name = "wall";
	this.wall.setTransform(425.05,278.7,0.6849,1,0,0,0,36.6,147.5);
	var wallFilter_1 = new cjs.ColorFilter(0.6015625,0.6015625,0.6015625,1,0,0,0,0);
	this.wall.filters = [wallFilter_1];
	this.wall.cache(30,-133,77,299);

	this.car = new lib.補間動畫1("synched",0);
	this.car.name = "car";
	this.car.setTransform(107.05,343.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.car},{t:this.wall}]}).wait(40));
	this.timeline.addTween(cjs.Tween.get(wallFilter_1).wait(40));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(306,200,165.7,200);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/flybird_atlas_1.png?1638711223924", id:"flybird_atlas_1"}
	],
	preloads: []
};
