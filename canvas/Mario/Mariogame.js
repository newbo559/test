(function (cjs, an) {
	...
	lib.ssMetadata = [
			{name:"Mariogame_atlas_1", frames: [[0,0,700,400],[366,477,58,59],[433,402,59,59],[426,524,58,59],[433,463,59,59],[0,538,58,59],[60,538,58,59],[0,477,59,59],[120,538,58,59],[61,477,59,59],[180,538,58,59],[240,538,58,59],[122,477,59,59],[300,538,58,59],[183,477,59,59],[360,538,58,59],[486,524,58,59],[244,477,59,59],[494,402,58,59],[305,477,59,59],[494,463,58,59],[420,585,36,48],[546,524,36,89],[0,402,431,73],[64,633,15,47],[64,599,24,32],[34,633,28,30],[0,633,32,32],[0,599,34,32],[36,599,26,32]]}
	];
	...
	(lib.bg = function() {
		this.initialize(ss["Mariogame_atlas_1"]);
		this.gotoAndStop(0);
	...
	p.nominalBounds = new cjs.Rectangle(-30,-59,59,59);
	...
	}).prototype = getMCSymbolPrototype(lib.Knife, new cjs.Rectangle(0,0,15,47), null);
	...
	if (reversed == null) { reversed = false; }
		...
		// 圖層_1
		this.instance = new lib.Floor01();
		this.instance.setTransform(0,0,1.6241,1);
	
		this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
	
		this._renderFirstFrame();
	
	}).prototype = getMCSymbolPrototype(lib.footer, new cjs.Rectangle(0,0,700,73), null);
	
	
	(lib.Dcsword = function(mode,startPosition,loop,reversed) {
	if (loop == null) { loop = true; }
	if (reversed == null) { reversed = false; }
		var props = new Object();
		props.mode = mode;
		...
		// 圖層_1
		this.instance = new lib.dcsword();
	
		this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
	
		this._renderFirstFrame();
	
	}).prototype = getMCSymbolPrototype(lib.Dcsword, new cjs.Rectangle(0,0,36,89), null);
	...
	// stage content:
	(lib.Mariogame = function(mode,startPosition,loop,reversed) {
	if (loop == null) { loop = true; }
	if (reversed == null) { reversed = false; }
		var props = new Object();
		props.mode = mode;
	...
	// library properties:
	lib.properties = {
		id: 'ECAC3827700BB64CBB03E158EBFFE5D8',
		width: 700,
		height: 400,
		fps: 60,
		color: "#CCCCCC",
		opacity: 1.00,
		manifest: [
			{src:"images/Mariogame_atlas_1.png?1639905551188", id:"Mariogame_atlas_1"}
		],
		preloads: []
	};
	...
	an.compositions['ECAC3827700BB64CBB03E158EBFFE5D8'] = {
